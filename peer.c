...
int main(int argc, char const *argv[])
{
    ...
    char own_address[15];
    scanf(" %s",  own_address);
    address.sin_addr.s_addr = inet_addr(own_address);
...
void sending()
{
    ...
    printf("\nEnter the IP to send to:");
    scanf("%s",  target_address);
    serv_addr.sin_addr.s_addr = inet_addr(target_address); //INADDR_ANY always gives an IP of 0.0.0.0
